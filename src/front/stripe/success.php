...
if (isset($_SESSION['stripe_session_id'])) {
	...
	update_post_meta($session_obj->metadata->id, 'carwash_payment', 'success');
?>
	<!DOCTYPE html>
	<html lang="en">
	...
	<head>
		...
		<title><?php echo __('Stripe Payment Success', 'carwash') ?></title>
		<style>
			body {
	...
	<body>
		<div class="success-info text-center">
			<h4><?php echo __('Payment Successfully Received', 'carwash') ?></h4>
			<h5><?php echo __('Your Payment details are', 'carwash') ?></h5>
			...
			<p class="item-txt"><?php echo __('Email: ', 'carwash') . $session_obj->customer_details->email ?></p>
